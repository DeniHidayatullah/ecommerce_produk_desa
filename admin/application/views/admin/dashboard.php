                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0">Rp</span>
                    </div>
                    <div class="col-auto">
          ...
          <div class="card bg-white">
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  <h6 class="text-uppercase ls-1 mb-1">Ringkasan</h6>
...
<script src="<?php echo base_url('assets/themes/argon/vendor/chart.js/dist/Chart.min.js'); ?>"></script>
<script>
//
// Charts
//
